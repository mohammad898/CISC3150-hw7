...
class UserIsADumbassException extends IllegalArgumentException{
    ...
    */
    ...
    class AlgebraFailException extends IllegalArgumentException{
        ...
        public AlgebraFailException(String error){
            super(error);
    ...
    class QuitMashingOnYourKeyboardException extends IllegalArgumentException{
        ...
        public QuitMashingOnYourKeyboardException(String error){
            super(error);
        }
    }
    ...
    public class BasicCalculator{
        ...
        public static void main(String args[]) {
            System.out.println("Addition(+),Subtraction(-),Multiplication(x) and Division(/) operators");
        ...
        public static boolean  argumentcheck(ArrayList<String> input) throws QuitMashingOnYourKeyboardException{
            ...
            for(int i = 1; i < input.size(); i+=2){
                ...
                if(i % 2 == 1 && input.get(i).equals("/") || input.get(i).equals("+") || input.get(i).equals("-") || input.get(i).equals("x") || input.get(i).equals("%")){
                } else {
                    throw new QuitMashingOnYourKeyboardException("  you  entered Illegal operation ");
                }
            }
            return true;
        }
        ...
        public static double operationcheck(ArrayList<String> input, int index) throws AlgebraFailException{
        ...
        public static boolean multiplication_Divition(ArrayList<String> input, int index){
            ...
            if(input.get(index).equals("x") || input.get(index).equals("/") || input.get(index).equals("%")){  
                return true;
            }
            return false;
        }
